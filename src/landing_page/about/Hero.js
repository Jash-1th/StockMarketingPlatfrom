...
function Hero() {
  return (
    <div className="row row-cols-1 p-md-5">
      <h2 className=" col-12 col-md-10 text-center border-bottom p-md-5  ms-md-5 pb-5">
        We pioneered the discount broking model in India. Now, we are breaking
        ground with our technology.
      </h2>
      <div className="row row-cols-md-2 p-md-5 pt-5">
            <div className="p-md-5" style={{letterSpacing:"1px"}}>
